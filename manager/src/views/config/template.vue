<template>
        ...
        <a-row :gutter='24'>
          <a-col :md='6' :sm='12'>
            <a-form-item label='模板名称'>
              <a-input placeholder='输入模板名称' v-model='queryParam.name'></a-input>
            </a-form-item>
          </a-col>
  ...
  <a-modal
    ...
    okText='确定'
  >
    <a-form ref='ruleForm' :label-col='labelCol' :wrapper-col='wrapperCol' :model='ruleForm'>
      <a-form-item required has-feedback label='用户名' name='materialName'>
        <a-input placeholder='请输入模板名称' v-model:value='ruleForm.materialName' />
      </a-form-item>
      <a-form-item has-feedback label='签章' name='materialImage'>
        <a-upload
          ...
          @change='handleChange'
        >
          <img v-if='imageUrl' :src='imageUrl' alt='材料模板' />
          <div v-else>
    ...
    const datap = reactive({
      ...
      columns: [
        ...
        },
        {
          ...
          slots: { customRender: 'templateImage' },
        },
        {
          title: '创建时间',
          align: 'center',
